...
BEGIN
	SELECT id, playerid, name, email, isAdmin, canAddGame, isApproved, claimedPlayerId FROM users;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	WHERE p.id NOT IN (SELECT u.playerid FROM users u);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    UPDATE users SET playerid = claimedPlayerId WHERE id = userid_p;
    SELECT * FROM users WHERE id = userid_p;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2018-10-08 17:53:12
